                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: image == null ? Image.network('${Api.baseUrl}${widget.product.product_image}')
                          ...
                          if(_form.currentState!.validate()){
                            ...
                            if(image == null){
                              ref.read(crudProvider.notifier).updateProduct(
                                  ...
                                  token: auth.user!.token, productId: widget.product.id
                              );
                            }else{
                              ref.read(crudProvider.notifier).updateProduct(
                                  product_name: nameController.text.trim(),
                                  ...
                                  countInStock: int.parse(stockController.text.trim()),
                                  image: image,
                                  imagePath: widget.product.product_image,
                                  token: auth.user!.token, productId: widget.product.id
                              );
